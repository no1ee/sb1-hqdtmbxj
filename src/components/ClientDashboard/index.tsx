...
export default function ClientDashboard() {
  ...
  const userPair = pairs.find(pair => pair.clientUsername === currentUser?.username);
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        {userPair ? (
          <AudioManager pairId={userPair.id} />
        ) : (
          <div className="text-center py-12">
            <p className="text-gray-500">
              You haven't been linked to a receiver yet. Please contact the administrator.
            </p>
          </div>
        )}
      </main>
